...
export const en: Record<keyof typeof ar, string> = {
  ...
  'search.title': 'Search',
  'search.placeholder': 'Search classmates, posts, topics…',
  ...
  'settings.privacy.whoCanSee': 'Who can see you',
  'settings.privacy.profileVisibility': 'Profile',
  'settings.privacy.defaultPostVisibility': 'New posts',
  'settings.privacy.whoCanMessage': 'Who can message you',
  'settings.privacy.discovery': 'Discovery',
  'settings.privacy.searchable': 'Appear in search',
  'settings.privacy.searchable.off': 'Off means your name will not appear in search results.',
  'settings.privacy.showActivity': 'Show study activity',
  'settings.privacy.showActivity.off': 'Off hides your recent answers from surfaces that mention them.',
  'settings.privacy.scope.stage': 'Your stage',
  'settings.privacy.scope.college': 'Your college',
  'settings.privacy.scope.university': 'Your university',
  'settings.privacy.scope.private': 'Only you',
  ...
  // --- preview feedback (preview builds only) -------------------------------
  'preview.feedback.open': 'Give feedback',
  'preview.feedback.title': 'Tell us how this felt',
  'preview.feedback.intro': 'This is a preview built for students to judge. Every answer is optional, and we do not ask for your name, your email or your college.',
  'preview.feedback.screen': 'Which screen is this about?',
  'preview.feedback.screen.overall': 'The whole app',
  'preview.feedback.screen.home': 'Home',
  'preview.feedback.screen.learn': 'Learn',
  'preview.feedback.screen.topic': 'Topic',
  'preview.feedback.screen.practice': 'Practice',
  'preview.feedback.screen.classroom': 'Classroom',
  'preview.feedback.screen.messages': 'Messages',
  'preview.feedback.screen.search': 'Search',
  'preview.feedback.screen.profile': 'Profile',
  'preview.feedback.screen.compose': 'Writing a post',
  'preview.feedback.screen.settings': 'Settings',
  'preview.feedback.clarity': 'Could you tell what you were looking at?',
  'preview.feedback.navigation': 'Could you get where you wanted to go?',
  'preview.feedback.usefulness': 'Would this help you study?',
  'preview.feedback.comfort': 'Was it comfortable to read?',
  'preview.feedback.scale.4': 'Yes, easily',
  'preview.feedback.scale.3': 'Mostly',
  'preview.feedback.scale.2': 'With effort',
  'preview.feedback.scale.1': 'No',
  'preview.feedback.confusion': 'What confused you?',
  'preview.feedback.confusion.hint': 'The place you stopped, re-read, or guessed.',
  'preview.feedback.change': 'What would you change?',
  'preview.feedback.change.hint': 'One thing is enough.',
  'preview.feedback.submit': 'Send feedback',
  'preview.feedback.sent.title': 'Thank you',
  'preview.feedback.sent.body': 'Your answers were recorded on this device.',
  'preview.feedback.sent.copy': 'Copy my answers',
  'preview.feedback.sent.copied': 'Copied.',
