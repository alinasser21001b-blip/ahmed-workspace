...
export const en: Record<keyof typeof ar, string> = {
  ...
  'post.reply': 'Reply',
  'post.delete.confirm.title': 'Delete this post?',
  'post.delete.confirm.body': 'It will be removed from the feed and from anyone who saved it. This cannot be undone.',
  'post.openProfile': 'Open profile',
  'saved.title': 'Saved',
  'saved.subtitle': 'Posts you kept for later',
  'saved.empty.title': 'Nothing saved yet',
  'saved.empty.body': 'Save a post from the feed and it waits for you here — with its sources, so you can come back to the evidence rather than the memory of it.',
  'saved.empty.action': 'Go to Today',
  'learn.saved.open': 'Saved posts',
