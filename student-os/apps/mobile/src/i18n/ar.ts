...
export const ar = {
  ...
  'post.reply': 'رد',
  'post.delete.confirm.title': 'حذف هذا المنشور؟',
  'post.delete.confirm.body': 'سيُحذف من التدفق ومن حفظه لدى الآخرين. لا يمكن التراجع عن هذا.',
  'post.openProfile': 'فتح الملف الشخصي',
  'saved.title': 'المحفوظات',
  'saved.subtitle': 'منشورات احتفظت بها للرجوع إليها',
  'saved.empty.title': 'لا شيء محفوظ بعد',
  'saved.empty.body': 'احفظ منشوراً من التدفق ليبقى هنا بانتظارك — مع مصادره، لتعود إلى الدليل نفسه لا إلى ذاكرتك عنه.',
  'saved.empty.action': 'إلى اليوم',
  'learn.saved.open': 'المنشورات المحفوظة',
