/**
 * The evidence registry behind every seeded tariff rule.
 *
 * Mirrors FINANCIAL-RESEARCH.md §12. `retrievalStatus` is recorded honestly:
 * outbound HTTP was blocked during the research session on 2026-08-31, so no
 * primary document was opened directly, and nothing here claims otherwise.
 */
export type SourceClass = 'PRIMARY' | 'SECONDARY';
export type RetrievalStatus = 'RETRIEVED' | 'BLOCKED' | 'SNIPPET_ONLY';
...
export interface FinancialSource {
  ...
  readonly retrievalStatus: RetrievalStatus;
  readonly notes: string;
}

const ACCESSED = '2026-08-31';

export const FINANCIAL_SOURCES: readonly FinancialSource[] = [
  {
...
export function sourceById(id: string): FinancialSource | undefined {
