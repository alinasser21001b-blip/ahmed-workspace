import type { FeeRule } from '../fees.ts';
import { majorUnits } from '../money.ts';
 ...
 * verified cost.
 */
export const SEED_FEE_RULES: readonly FeeRule[] = [
  // ---------------------------------------------------------------- NEO ----
  {
    ...
    isAmbiguous: false,
    notes:
      'Research record NEO-01. Saudi Arabia is inside Visa CEMEA, so this 2% tier is the one that ' +
  ...
  },
  {
    ...
    isAmbiguous: true,
    ambiguityNote:
      'Published as a 3,000–4,000 IQD range with no stated trigger for either end. The engine carries ' +
  ...
  // ---------------------------------------------------------------- NBI ----
  {
    ...
    isAmbiguous: true,
    ambiguityNote:
      'The tariff says "ATMs outside the national network". That may mean other Iraqi banks\' ATMs ' +
  ...
  },
  {
    ...
    isAmbiguous: false,
    notes:
      'Research record NBI-05. The foreign transaction commission was NOT found. It is unknown, not zero, ' +
  ...
  // ------------------------------------------------------- Rafidain / Qi ----
  {
    ...
    isAmbiguous: false,
    notes:
      'Research record QI-06. No international ATM fee is published for any Rafidain/Qi product. ' +
  ...
  },
  {
    ...
    isAmbiguous: false,
    notes:
      'Research record QI-03. Qi markets a "guaranteed exchange rate" but publishes no rate and no margin, ' +
 ...
 */
export const UNKNOWN_RULE_IDS: readonly string[] = SEED_FEE_RULES.filter(
