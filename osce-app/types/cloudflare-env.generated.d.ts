/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv types/cloudflare-env.generated.d.ts` (hash: 9df510497bf9dbe8f2e80bbacd829956)
// Runtime types generated with workerd@1.20260828.1 2026-08-28 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DOCUMENTS: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	ADMIN_KNOWLEDGE_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_KNOWLEDGE_TOKEN">> {}
}
